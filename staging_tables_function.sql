-- Create staging tables for caching
CREATE TABLE IF NOT EXISTS lux_staging.cache_lfs AS SELECT "Sold_to_Party" FROM lux_production.lfs_customer_list;
CREATE TABLE IF NOT EXISTS lux_staging.cache_export AS SELECT "Code" FROM lux_production.export_customer_list;
CREATE TABLE IF NOT EXISTS lux_staging.cache_annexure_1 AS SELECT "Material_Number" FROM lux_production.annexure_1;
CREATE TABLE IF NOT EXISTS lux_staging.cache_annexure_2 AS SELECT "Material_Number" FROM lux_production.annexure_2;
CREATE TABLE IF NOT EXISTS lux_staging.cache_annexure_3 AS SELECT "Material_Number" FROM lux_production.annexure_3;
CREATE TABLE IF NOT EXISTS lux_staging.cache_brand_logic AS SELECT "Material_Number", "Re_Brand" FROM lux_production.brand_logic;
CREATE TABLE IF NOT EXISTS lux_staging.cache_gender AS SELECT old_matl_number::text, "Gender" FROM lux_production.gender;

CREATE INDEX IF NOT EXISTS idx_cache_lfs ON lux_staging.cache_lfs("Sold_to_Party");
CREATE INDEX IF NOT EXISTS idx_cache_export ON lux_staging.cache_export("Code");
CREATE INDEX IF NOT EXISTS idx_cache_annexure_1 ON lux_staging.cache_annexure_1("Material_Number");
CREATE INDEX IF NOT EXISTS idx_cache_annexure_2 ON lux_staging.cache_annexure_2("Material_Number");
CREATE INDEX IF NOT EXISTS idx_cache_annexure_3 ON lux_staging.cache_annexure_3("Material_Number");
CREATE INDEX IF NOT EXISTS idx_cache_brand_logic ON lux_staging.cache_brand_logic("Material_Number");
CREATE INDEX IF NOT EXISTS idx_cache_gender ON lux_staging.cache_gender(old_matl_number);

-- Fast cached function using staging tables
...
BEGIN
    -- Fast lookups using staging cache tables
