...
WITH lookup_flags AS (
    SELECT 
        ...
        CASE WHEN a1."Material_Number" IS NOT NULL THEN true ELSE false END AS in_a1,
        CASE WHEN a2."Material_Number" IS NOT NULL THEN true ELSE false END AS in_a2,
        CASE WHEN a3."Material_Number" IS NOT NULL THEN true ELSE false END AS in_a3,
    ...
    SELECT 
        ...
        CASE
            ...
            WHEN sales_org <> 'LI05' AND sales_org IN ('3000','AR01','AS01','EB01','JM01','JM02','JM03','JT01','LC01','LC02','LC03','LC04','LC05','LC06','LI01','LI02','LI03','LI04','LI06','LI07','LI09','LI10','LX01','LX02','LX03','LX04','ON01')
                 AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38') AND mat_desc NOT ILIKE 'REJ%' AND is_lfs THEN 'LFS'
            WHEN material_type IN ('FERT', 'HAWA') AND billing_type IN ('F3','ZRE','ZRER','ZRF','ZRR') AND business_area NOT IN ('LI26', 'LI38') 
                 AND mat_desc NOT ILIKE 'REJ%' AND NOT is_lfs AND is_export THEN 'Export'
            ...
            WHEN sales_org = 'LI10' AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%' THEN 'Lux Parker Inner'
            WHEN sales_org = 'LI09' AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%' THEN 'Lux Pynk'
            WHEN sales_org IN ('LI02','LI03','LI07') AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%'
                 AND (in_a1 OR in_a2) THEN 'Onn - Winter'
            WHEN sales_org = 'LI06' AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%' AND NOT in_a3 THEN 'Lux Cozi Outerwear Men'
            WHEN sales_org = 'LI03' AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%' AND NOT in_a1 THEN 'Winter'
            WHEN sales_org = 'LI02' AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%' AND NOT in_a2 THEN 'Onn'
            WHEN sales_org = 'LI01' AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%' AND NOT in_a3 THEN 'Lux Cozi'
            WHEN sales_org IN ('LI01','LI06') AND material_type IN ('FERT', 'HAWA') AND business_area NOT IN ('LI26', 'LI38')
                 AND mat_desc NOT ILIKE 'REJ%' AND billing_type <> 'F3' AND NOT is_lfs AND mat_desc NOT ILIKE 'AX%' AND mat_desc NOT ILIKE 'One8%'
                 AND (mat_desc ILIKE '%boyz%' OR mat_desc ILIKE '%boys%') AND in_a3 THEN 'Lux Cozi Boys'
...
SELECT 
    ...
    CASE 
        ...
        WHEN channel IN ('LFS', 'E-com', 'EBO') THEN COALESCE(brand_logic, 'Others')
        ELSE 'Others'
    END AS brand,
